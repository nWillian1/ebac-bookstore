...
class Category(
    models.Model
):  # Modelo de categoria com campos para título, slug, descrição e ativo
    ...
    active = models.BooleanField(
        default=True
    )  # Campo para indicar se a categoria está ativa.

    def __unicode__(
        self,
    ):  # Método para retornar o título da categoria como representação em string
