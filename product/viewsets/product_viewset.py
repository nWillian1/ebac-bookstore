...
from rest_framework.permissions import IsAuthenticatedOrReadOnly # importando as classes de permissão para a viewset e verificar se o usuário está autenticado
...
class ProductViewSet(ModelViewSet): # definindo a classe ProductViewSet que herda de ModelViewSet
    ...
    permission_classes = [IsAuthenticatedOrReadOnly] # define as classes de permissão para a viewset 
